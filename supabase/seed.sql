...
-- Measures
insert into public.measures (id, user_id, category_id, title, unit, color, icon) values
  ('e0000001-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 'ca000001-0000-0000-0000-000000000001', 'Hours of Sleep', 'hours', '#8b5cf6', 'bed'),
  ('e0000001-0000-0000-0000-000000000002', 'a1111111-1111-1111-1111-111111111111', 'ca000001-0000-0000-0000-000000000001', 'Step Count', 'steps', '#10b981', 'footprints'),
  ('e0000001-0000-0000-0000-000000000003', 'a1111111-1111-1111-1111-111111111111', null, 'Screen Time', 'hours', '#f59e0b', 'gauge');

-- Measure Logs (last 7 days)
insert into public.measure_logs (user_id, measure_id, logged_at, value) values
  -- Hours of Sleep
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000001', current_date - 6, 7.5),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000001', current_date - 5, 6.0),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000001', current_date - 4, 8.0),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000001', current_date - 3, 7.0),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000001', current_date - 2, 6.5),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000001', current_date - 1, 7.5),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000001', current_date, 8.0),
  -- Step Count
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000002', current_date - 6, 8500),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000002', current_date - 5, 12000),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000002', current_date - 4, 6200),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000002', current_date - 3, 10500),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000002', current_date - 1, 9800),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000002', current_date, 4500),
  -- Screen Time
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000003', current_date - 6, 3.5),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000003', current_date - 5, 5.0),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000003', current_date - 4, 2.5),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000003', current_date - 3, 4.0),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000003', current_date - 2, 6.0),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000003', current_date - 1, 3.0),
  ('a1111111-1111-1111-1111-111111111111', 'e0000001-0000-0000-0000-000000000003', current_date, 2.0);
